...
export const CalorieIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={`${styles.icon} ${styles.order}`}>
...
export const MinusIcon = (props) => {
  return (
    <svg onClick={props.onClick} xmlns="http://www.w3.org/2000/svg" className={`${styles.icon} ${styles.order}`}>
...
export const SearchIcon = (props) => {
  const classes = props.classes ? `${styles[`${props.classes}`]} ${styles.icon}` : `${styles.icon}`;
...
export const Trash = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={`${styles.icon} ${styles.cart}`}>
...
export const SadFace = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 30" className={`${styles.icon} ${styles["cart-face"]}`}>
...
export const ChevronLeft = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={`${styles.icon} ${styles["icon-chevron"]}`}>
...
export const HomeIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`${styles.icon} ${styles.contact}`}>
